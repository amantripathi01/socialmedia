...
describe('addCommentOnPost', () => {
  ...
  it('dispatches addCommentRequest action when called', async () => {
    await addCommentOnPost(id, comment)(dispatch);
    expect(dispatch).toHaveBeenCalledWith({ type: 'addCommentRequest' });
  });

  it('dispatches addCommentSuccess action when API call is successful', async () => {
  ...
  it('dispatches addCommentFailure action when API call fails', async () => {
